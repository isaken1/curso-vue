<template>
	<div id="app">
		...
		<p v-quando:mouseenter="mouseEnter" >Teste</p>
		<p v-quando:mouseleave="mouseLeave" >Teste2</p>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		mouseEnter() {
			console.log('Mouse entrou aqui!')
		}, 
		mouseLeave() {
			console.log('Mouse saiu daqui!')
		}
	}
}
</script>
